 ...
 */
@ApplicationScoped
@WorkbenchScreen(identifier = "P3ClearEditorcreen")
public class P3ClearEditorPresenter implements ExplorerPresenter {

    @Inject
    private ExplorerView view;

    @Inject
    private SingleBusinessViewPresenterImpl businessViewPresenter;

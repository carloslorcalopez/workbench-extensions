 ...
 */
@ApplicationScoped
public class P3BusinessViewWidget extends Composite implements View {
    ...
    interface P3BusinessViewImplBinder
            extends
            UiBinder<Widget, P3BusinessViewWidget> {

    }

    private static P3BusinessViewImplBinder uiBinder = GWT.create( P3BusinessViewImplBinder.class );
